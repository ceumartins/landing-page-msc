    ...
    <LayoutDashboard>
      <div className="w-full flex flex-col items-center justify-center">
        ...
        <section className="sm:w-screen lg:px-60 py-12 lg:py-20 flex-col justify-center items-start bg-primary_first_color">
          ...
          <p className="w-full px-2 text-center mt-4 mb-6 lg:mb-16 text-bright_color font-bold text-lg lg:text-2xl">
          ...
          <div className="flex flex-col w-full items-center">
            <Link href="https://www.simplesdecredito.com.br/esc/cadastro/bem-vindo">
              <a
                ...
                data-type="URL"
                target="_blank"
                className="flex mt-12 items-center justify-center text-sm lg:text-base font-bold text-center py-4 px-6 lg:px-12 transition-colors duration-150 text-bright_color rounded-lg bg-secundary_first_color hover:bg-secundary_second_color"
              >
